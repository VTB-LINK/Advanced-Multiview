...
| M4 / Phase 2 | 主体功能已完成（Label/Background/SafeArea/Overlay/VU Meter/Highlight、三层 Visual Settings、动态生效） | `Phase 2（M4）主体功能已完成，进入 Phase 2.5 收尾` |
| Phase 2.5 | 进行中（文档重基线、术语统一、Phase 2 验收清单、VU meter polish 设计） | `Phase 2.5（M4 收尾 / Phase 3 准备）进行中` |

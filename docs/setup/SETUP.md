...
#### 2. 安装 Visual Studio 2022 或 2026
**这是接下来最重要的步骤！**

> ⚠️ **版本选择说明**：
> - **Visual Studio 2022**：稳定版，MSVC v143 工具集
> - **Visual Studio 2026**：预览版，MSVC v180+ 工具集（当前项目配置）
> 
> 如果选择 VS 2022，需修改 [CMakePresets.json](../../CMakePresets.json) 第 59 行：
> ```json
> "generator": "Visual Studio 17 2022",  // 从 "Visual Studio 18 2026" 改为此
> ```

1. **下载地址**：https://visualstudio.microsoft.com/zh-hans/downloads/
   - VS 2022：选择 Community（免费）
   - VS 2026：选择 Preview 版本
...
4. **确认右侧组件**：
   - ✅ **MSVC v143**（VS 2022）或 **MSVC v180**（VS 2026）C++ x64/x86 生成工具（最新版本）
   - ✅ Windows 11 SDK (10.0.22621.0 或更高)
   - ✅ 用于 Windows 的 C++ CMake 工具
   - ✅ C++ Clang 编译器（用于代码格式化）

5. **安装**：大小约 6-8 GB，耗时视网络情况而定

6. **重启 PowerShell** 完成环境变量更新
...
docs/setup/
  ...
  ├── configure-cmake.ps1 # CMake 配置脚本
  ├── setup-cmake-path*.ps1 # PATH 配置脚本
  ├── SETUP.md           # 本文档
